...
declare @var_Cli_Apeliido nvarchar (255);
...
into @var_Cli_Dni,@var_Cli_Apeliido,@var_cli_Nombre,@var_cli_Fecha_Nac,
 ...
 while @@fetch_status = 0
  begin
	 ...
	 begin
	    ...
	    insert into dbo.Cliente (Cliente_Id,Cliente_Dni,Cliente_Apeliido,Cliente_Nombre,Cliente_Fecha_Nac)
	    values(@var_Id,@var_Cli_Dni, @var_Cli_Apeliido, @var_cli_Nombre, @var_cli_Fecha_Nac);
	 end
	     else
	 begin
	    insert into dbo.Usuario(Usuario_Id,Usuario_Mail,Usuario_Dom_Calle, Usuario_Nro_Calle, Usuario_Piso,Usuario_Depto, Usuario_Cod_Postal) 
